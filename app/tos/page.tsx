  ...
  return (
    <main className="max-w-2xl mx-auto px-4 py-12">
      ...
      <section className="space-y-4 text-gray-300 leading-relaxed">
        <p>By using ChatAnon, you confirm that you are at least <strong>18 years old</strong>.</p>
        ...
        <p>ChatAnon provides a report button in every chat. Reports are reviewed manually. We reserve the right to ban users who violate these terms.</p>
        ...
        <p>ChatAnon is not responsible for the content of user conversations. Use this service at your own risk.</p>
